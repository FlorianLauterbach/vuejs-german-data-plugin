  ...
  install: (app, options) => {
    const entries = [
      ...
      },
      {
        ...
        name: "Bredstedt Bräist / Bredsted",
        state: "Schleswig-Holstein",
      },
      {
        coords: {
      ...
      },
      {
        ...
        district: "Bad Dürkheim",
        name: "Lambrecht, Rheinland-Pfalz",
        state: "Rheinland-Pfalz",
      },
      {
        coords: {
      ...
      },
      {
        ...
        district: "Ludwigshafen am Rhein",
      ...
      },
      {
        ...
        district: "Neustadt an der Weinstraße",
      ...
      },
      {
        ...
        district: "Weiden in der Oberpfalz",
    ...
    app.config.globalProperties.$germanData = entries;

    app.config.globalProperties.$getStates = function () {
      let states = [];
      ...
      return states.filter(function(item, pos) {
        return states.indexOf(item) == pos;
      })
    }

    app.config.globalProperties.$getDistrictByState = function (state) {
      let districts = [];
      ...
      return districts.filter(function(item, pos) {
    ...
    app.config.globalProperties.$getCitiesByDistrict = function (district) {
      ...
      return cities.filter(function(item, pos) {
